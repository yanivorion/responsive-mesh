...
12. [Gaps & Future Work](#12-gaps--future-work)
...
11. **Parking lot**: Currently visual only (hatch overlay + reduced opacity). Future: parked elements should be excluded from layout export and live preview.
